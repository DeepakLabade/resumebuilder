...
$exps = $db->query("SELECT * FROM experience resume WHERE (resume_id=".$resume['id'].") ");
$exps = $exps->fetch_all(1);

$edus = $db->query("SELECT * FROM educations resume WHERE (resume_id=".$resume['id'].") ");
$edus = $edus->fetch_all(1);

$skills = $db->query("SELECT * FROM skills resume WHERE (resume_id=".$resume['id'].") ");
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="marital_status">
                            ...
                            <option <?=($resume['marital_status']=='Diverced')?'selected':''?>>Divorced</option>
...
<div class="modal fade" id="addexp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-12">
    ...
    <input type="password" class="form-control" name="company" placeholder="Dominos,New Delhi" id="inputPassword4" required>
  </div>
  <div class="col-md-6">
  ...
  <div class="col-12">
    <label for="inputPasswords" class="form-label">job description</label>
...
<!-- modal -->
  ...
  <div class="col-12">
    ...
    <input type="password" class="form-control" name="institute" placeholder="Central Board Of Secondary Education, New Delhi" id="inputPassword4" required>
  </div>
  <div class="col-md-6">
